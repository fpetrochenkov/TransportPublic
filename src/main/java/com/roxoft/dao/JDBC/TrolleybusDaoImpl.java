...
public class TrolleybusDaoImpl implements ITrolleybusDao {
	...
	public Trolleybus read(int key){
		...
		String sql = "SELECT name, transport_type.type, transport.number, "
				+ "a1.street, drivers.first_name, drivers.last_name,  "
				+ "a1.house_number, a2.street, a2.house_number FROM schema.depos "
				...
				+ "Inner join drivers on transport.drivers_id = drivers.id where transport_type.id = 2 and transport.id = ?";
	...
	public List<Trolleybus> getAll(){
		...
		String sql = "SELECT name, transport_type.type, transport.number, a1.street, drivers.first_name, "
				...
				+ "Inner join address a1 on route.station_from=a1.id "
				+ "Inner join address a2 on route.station_to=a2.id "
				+ "Inner join drivers on transport.drivers_id = drivers.id where transport_type.id = 2";
